...
class WorkflowRegistry:
    def __init__(self) -> None:
        self._handlers = {
            ...
            Stage.DEBATE: WorkflowHandler(Stage.DEBATE, "Pressure-test the user's actual claim as an opponent.", ("Position", "Reasoning", "Argument"), ("Challenges and responses",), ("assistant_message", "extracted_facts"), ("Challenge only user-expressed claims, reasoning, assumptions, and boundaries.", "Do not supply missing arguments for the user.")),
